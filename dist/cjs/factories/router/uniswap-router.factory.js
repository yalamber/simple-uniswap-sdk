...
var UniswapRouterFactory = /** @class */ (function () {
                                ...
                                calls: [
                                    {
                                        ...
                                        methodName: 'getPool',
                                        methodParameters: [
                                            eth_1.removeEthFromContractAddress(this._fromToken.contractAddress),
                                            eth_1.removeEthFromContractAddress(this._toToken.contractAddress),
    ...
    UniswapRouterFactory.prototype.generateTradeDataEthToErc20Input = function (ethAmountIn, tokenAmount, routeQuoteTradeContext, deadline, transferFee) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                if (transferFee) {
                    return this._uniswapRouterContractFactoryV2.swapExactETHForTokensSupportingFeeOnTransferTokens(hexlify_1.hexlify(convertedMinTokens), routeQuoteTradeContext.routePathArray.map(function (r) {
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return this.generateTradeDataForV3Input(parse_ether_1.parseEther(ethAmountIn), convertedMinTokens, routeQuoteTradeContext.liquidityProviderFee, deadline);
            default:
    ...
    UniswapRouterFactory.prototype.generateTradeDataEthToErc20Output = function (ethAmountInMax, tokenAmountOut, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return this.generateTradeDataForV3Output(amountOut, parse_ether_1.parseEther(ethAmountInMax), routeQuoteTradeContext.liquidityProviderFee, deadline);
            default:
                throw new uniswap_error_1.UniswapError('Uniswap version not supported', error_codes_1.ErrorCodes.uniswapVersionNotSupported);
        }
    };
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToEthInput = function (tokenAmount, ethAmountOutMin, routeQuoteTradeContext, deadline, transferFee) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                if (transferFee) {
                    return this._uniswapRouterContractFactoryV2.swapExactTokensForETHSupportingFeeOnTransferTokens(hexlify_1.hexlify(amountIn), hexlify_1.hexlify(parse_ether_1.parseEther(ethAmountOutMin)), routeQuoteTradeContext.routePathArray.map(function (r) {
                        return eth_1.removeEthFromContractAddress(r);
                    }), this._ethereumAddress, deadline);
                }
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return this.generateTradeDataForV3Input(amountIn, parse_ether_1.parseEther(ethAmountOutMin), routeQuoteTradeContext.liquidityProviderFee, deadline);
            default:
                throw new uniswap_error_1.UniswapError('Uniswap version not supported', error_codes_1.ErrorCodes.uniswapVersionNotSupported);
        }
    };
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToEthOutput = function (tokenAmountInMax, ethAmountOut, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return this.generateTradeDataForV3Output(parse_ether_1.parseEther(ethAmountOut), amountInMax, routeQuoteTradeContext.liquidityProviderFee, deadline);
            default:
                throw new uniswap_error_1.UniswapError('Uniswap version not supported', error_codes_1.ErrorCodes.uniswapVersionNotSupported);
        }
    };
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToErc20Input = function (tokenAmount, tokenAmountMin, routeQuoteTradeContext, deadline, transferFee) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                if (transferFee) {
                    return this._uniswapRouterContractFactoryV2.swapExactTokensForTokensSupportingFeeOnTransferTokens(hexlify_1.hexlify(amountIn), hexlify_1.hexlify(amountMin), routeQuoteTradeContext.routePathArray, this._ethereumAddress, deadline);
                }
    ...
    UniswapRouterFactory.prototype.generateTradeDataForV3Input = function (tokenAmount, tokenAmountMin, liquidityProviderFee, deadline) {
        ...
        var params = {
            ...
            fee: fee_amount_v3_1.percentToFeeAmount(liquidityProviderFee),
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return {
                    ...
                    routePathArrayTokenMap: [
                        eth_1.turnTokenIntoEthForResponse(this._fromToken, (_b = (_a = this._settings) === null || _a === void 0 ? void 0 : _a.customNetwork) === null || _b === void 0 ? void 0 : _b.nativeCurrency),
                        this._toToken,
                    ],
                    routeText: eth_1.turnTokenIntoEthForResponse(this._fromToken, (_d = (_c = this._settings) === null || _c === void 0 ? void 0 : _c.customNetwork) === null || _d === void 0 ? void 0 : _d.nativeCurrency).symbol + " > " + this._toToken.symbol,
                    routePathArray: [
                        this._fromToken.contractAddress,
                        this._toToken.contractAddress,
                    ],
        ...
        switch (uniswapVersion) {
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return {
                    ...
                    routePathArrayTokenMap: [
                        this._fromToken,
                        eth_1.turnTokenIntoEthForResponse(this._toToken, (_b = (_a = this._settings) === null || _a === void 0 ? void 0 : _a.customNetwork) === null || _b === void 0 ? void 0 : _b.nativeCurrency),
                    ],
                    routeText: this._fromToken.symbol + " > " + eth_1.turnTokenIntoEthForResponse(this._toToken, (_d = (_c = this._settings) === null || _c === void 0 ? void 0 : _c.customNetwork) === null || _d === void 0 ? void 0 : _d.nativeCurrency).symbol,
                    routePathArray: [
                        this._fromToken.contractAddress,
                        this._toToken.contractAddress,
                    ],
