...
var UniswapPairFactory = /** @class */ (function () {
                ...
                switch (_e.label) {
                    ...
                    case 4:
                        tradeContext = (_d.approvalTransaction = _c,
                            _d.toToken = eth_1.turnTokenIntoEthForResponse(this.toToken, (_b = (_a = this._uniswapPairFactoryContext.settings) === null || _a === void 0 ? void 0 : _a.customNetwork) === null || _b === void 0 ? void 0 : _b.nativeCurrency),
                    ...
                    case 1:
                        ...
                        tradeContext = {
                            ...
                            toBalance: new bignumber_js_1.default(bestRouteQuotes.toBalance)
                                .shiftedBy(this.toToken.decimals * -1)
                                .toFixed(),
                            fromToken: eth_1.turnTokenIntoEthForResponse(this.fromToken, (_b = (_a = this._uniswapPairFactoryContext.settings) === null || _a === void 0 ? void 0 : _a.customNetwork) === null || _b === void 0 ? void 0 : _b.nativeCurrency),
                            fromBalance: {
                                hasEnough: bestRouteQuotes.hasEnoughBalance,
                                balance: bestRouteQuotes.fromBalance,
                            },
    ...
    UniswapPairFactory.prototype.tradePath = function () {
        ...
        return trade_path_1.getTradePath(network.chainId, this.fromToken, this.toToken, (_a = this._uniswapPairFactoryContext.settings.customNetwork) === null || _a === void 0 ? void 0 : _a.nativeWrappedTokenInfo);
    };
    /**
