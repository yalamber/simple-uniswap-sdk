...
var TokenFactory = /** @class */ (function () {
    function TokenFactory(_tokenContractAddress, _ethersProvider, _customNetwork, _cloneUniswapContractDetails) {
        ...
        this._erc20TokenContract = this._ethersProvider.getContract(JSON.stringify(contract_context_1.ContractContext.erc20Abi), get_address_1.getAddress(this._tokenContractAddress));
    }
    /**
    ...
    TokenFactory.prototype.getToken = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!eth_1.isNativeEth(this._tokenContractAddress)) return [3 /*break*/, 1];
                    ...
                    case 1:
                        overridenToken = overrides_1.isTokenOverrideInfo(this._tokenContractAddress);
                        if (overridenToken) {
                        ...
                        contractCallContext = {
                            reference: 'token',
                            contractAddress: get_address_1.getAddress(this._tokenContractAddress),
    ...
    TokenFactory.prototype.generateApproveAllowanceData = function (spender, value) {
        if (eth_1.isNativeEth(this._tokenContractAddress)) {
    ...
    TokenFactory.prototype.balanceOf = function (ethereumAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!eth_1.isNativeEth(this._tokenContractAddress)) return [3 /*break*/, 2];
