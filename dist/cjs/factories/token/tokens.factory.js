...
var TokensFactory = /** @class */ (function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        for (i = 0; i < tokenContractAddresses.length; i++) {
                            if (!eth_1.isNativeEth(tokenContractAddresses[i])) {
                                overridenToken = overrides_1.isTokenOverrideInfo(tokenContractAddresses[i]);
                                if (overridenToken) {
                                ...
                                contractCallContext = {
                                    reference: "token" + i,
                                    contractAddress: get_address_1.getAddress(tokenContractAddresses[i]),
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 1:
                        ...
                        if (!!eth_1.isNativeEth(tokenContractAddresses[i])) return [3 /*break*/, 2];
    ...
    TokensFactory.prototype.buildAllowanceAndBalanceContractCallContext = function (ethereumAddress, tokenContractAddress, uniswapVersion) {
        var defaultCallContext = {
            ...
            contractAddress: get_address_1.getAddress(tokenContractAddress),
            abi: contract_context_1.ContractContext.erc20Abi,
            calls: [
                {
                    reference: 'allowance',
        ...
        var overridenToken = overrides_1.isTokenOverrideInfo(tokenContractAddress);
        if (overridenToken) {
