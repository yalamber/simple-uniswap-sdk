...
var turnTokenIntoEthForResponse = function (token, nativeCurrencyInfo) {
    var clone = deep_clone_1.deepClone(token);
...
var ETH = /** @class */ (function () {
    ...
    ETH.MAINNET = function () {
        return {
            ...
            contractAddress: exports.appendEthToContractAddress('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'),
            decimals: 18,
    ...
    ETH.ROPSTEN = function () {
        return {
            ...
            contractAddress: exports.appendEthToContractAddress('0xc778417E063141139Fce010982780140Aa0cD5Ab'),
            decimals: 18,
            symbol: exports.ETH_SYMBOL,
            name: exports.ETH_NAME,
        };
    ...
    ETH.GORLI = function () {
        return {
            ...
            contractAddress: exports.appendEthToContractAddress('0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6'),
            decimals: 18,
            symbol: exports.ETH_SYMBOL,
            name: exports.ETH_NAME,
        };
    ...
    ETH.KOVAN = function () {
        return {
            ...
            contractAddress: exports.appendEthToContractAddress('0xd0A1E359811322d97991E03f863a0C30C2cF029C'),
            decimals: 18,
            symbol: exports.ETH_SYMBOL,
            name: exports.ETH_NAME,
        };
    ...
    ETH.info = function (chainId, customNetworkNativeWrappedTokenInfo) {
        ...
        if (customNetworkNativeWrappedTokenInfo) {
            return __assign(__assign({}, customNetworkNativeWrappedTokenInfo), { contractAddress: exports.appendEthToContractAddress(customNetworkNativeWrappedTokenInfo.contractAddress) });
        }
        switch (chainId) {
