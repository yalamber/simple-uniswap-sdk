...
var EthersProvider = /** @class */ (function () {
    ...
    EthersProvider.prototype.getChainName = function (chainId) {
        ...
        if (!chainName) {
            throw new UniswapError("Can not find chain name for " + chainId + ". This lib only supports mainnet(1), ropsten(4), kovan(42), rinkeby(4) and g\u00F6rli(5)", ErrorCodes.canNotFindChainId);
        }
        return chainName;
    };
    /**
