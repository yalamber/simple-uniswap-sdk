...
export declare class UniswapPairFactory {
    ...
    private _uniswapRouterFactory;
    private _watchingBlocks;
    private _currentTradeContext;
    private _quoteChanged$;
    constructor(_coinGecko: CoinGecko, _uniswapPairFactoryContext: UniswapPairFactoryContext);
    /**
     * The to token
     */
    get toToken(): Token;
     ...
     */
    findAllPossibleRoutes(): Promise<AllPossibleRoutes>;
    /**
     ...
     * @param uniswapVersion The uniswap version
     */
    allowance(uniswapVersion: UniswapVersion): Promise<string>;
    /**
     ...
     * @param uniswapVersion The uniswap version
     */
    generateApproveMaxAllowanceData(uniswapVersion: UniswapVersion): Promise<Transaction>;
    /**
     * Route getter
     */
    private get _routes();
