...
var UniswapRouterContractFactoryV2 = /** @class */ (function () {
    ...
    UniswapRouterContractFactoryV2.prototype.swapExactETHForTokensSupportingFeeOnTransferTokens = function (amountOutMin, path, to, deadline) {
        return this._uniswapRouterContract.interface.encodeFunctionData('swapExactETHForTokensSupportingFeeOnTransferTokens', [amountOutMin, path, to, deadline]);
    };
